...
class ClientPrefs {
	...
	public static var notefunctionality:Bool = false;
	...
	public static function saveSettings() {
		...
		FlxG.save.data.notefunctionality = notefunctionality;
	...
	public static function loadPrefs() {
		...
		if(FlxG.save.data.notefunctionality != null) {
			notefunctionality = FlxG.save.data.notefunctionality;
		}
